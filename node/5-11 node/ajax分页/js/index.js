...
var pageModel = (function(){
    ...
    function bindHTML(ary){
        ...
        var str= "";
           for(var i = 0; i < ary.length;i++){
               ...
               var userInfo = ary[i];
               //绑定用户信息
               str += "<li userId='"+userInfo.id+"'><span>"+userInfo.id+"</span><span>"+userInfo.name+"</span> <span>"+(userInfo.sex>0?"男":"女")+"</span> <span>"+userInfo.score+"</span></li>";
           }
    ...
    function  sendAjax(){
        ajax({
            type:"get",//请求方式
            url:"/getListUser?page="+curPage,//路径
            dataType:"json",
            async:true,
            data:null,
            success:function(data){
                console.log(data);
                totol = parseInt(data.totol);//获取总页数
